...
// stamp1 圖案來自 public/stamps/stamp1.svg，花色透過 CSS filter 控制
// 6 色對應 hue-rotate + saturate filter
const STAMP_HUE_FILTERS = [
  'none',                                              // 橘色（原色）
  'hue-rotate(40deg) saturate(2)',                    // 黃色
  'hue-rotate(320deg)',                               // 粉色
  'hue-rotate(200deg)',                               // 藍色
  'hue-rotate(260deg)',                               // 紫色
  'hue-rotate(100deg)',                               // 綠色
]
            ...
            <>
              ...
              <foreignObject x="4" y="4" width="96" height="96">
                <img
                  ...
                  width="96"
                  height="96"
                  style={{ filter: STAMP_HUE_FILTERS[index % 6] }}
                />
              </foreignObject>
            </>
